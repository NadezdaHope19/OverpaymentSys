...
На начальном этапе был проведен анализ бизнеса-процесса по работе с переплатами, в ходе которого было выявлены узкие места, простои, отсутствие контрольных точек (![диаграмма AS IS](https://github.com/NadezdaHope19/OverpaymentSys/blob/main/diagrams/ASIS.png?raw=true)).  
